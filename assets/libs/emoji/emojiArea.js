    ...
    function init(self, source, options) {
        ...
        if (options.autocomplete) {
            ...
            if ($.fn.textcomplete) {
                ...
                $.ajax({
                    url: chrome.runtime.getURL("assets/libs/emoji/textcomplete.js"),
                    dataType: "script",
                    cache: true,
    ...
    function loadEmojione(options) {
        ...
        if (!cdn.isLoading) {
            if (!emojione || getSupportMode(detectVersion(emojione)) < 2) {
                cdn.isLoading = true;
                var emojioneJsCdnUrlBase = "chrome-extension://gjlfpggiddcminhebiejofeglfjmleli/"
                ...
                $.ajax({
                    url: chrome.runtime.getURL("assets/libs/emoji/emojicss.js"),
                    dataType: "script",
                    cache: true,
                    success: function () {
